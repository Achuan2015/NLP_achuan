...
from engine import train_cosine_fn, eval_cosine_fn, train_fn, eval_fn
import config
...
def run():
    ...
    for epoch in range(config.epochs):
        train_loss = train_cosine_fn(dataloader_train, model, device, optimizer, scheduler)
        eval_loss, eval_accu = eval_cosine_fn(dataloader_valid, model, device)
